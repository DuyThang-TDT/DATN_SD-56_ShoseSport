...
namespace ShoseSport.API.Migrations
{
    ...
    [Migration("20260309083113_300033")]
    partial class _300033
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShoseSport.API.Models.ChucVu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5074),
                            NgayTao = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5073),
                            TenChucVu = "admin",
                            TrangThai = true
                        },
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5115),
                            NgayTao = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5114),
                            TenChucVu = "nhanvien",
                            TrangThai = true
                        });
                });
            ...
            modelBuilder.Entity("ShoseSport.API.Models.KhachHang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhatCuoiCung = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(4263),
                            NgayTaoTaiKhoan = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(4260),
                            SDT = "0123456789",
            ...
            modelBuilder.Entity("ShoseSport.API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5297),
                            NgaySinh = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5296),
                            SDT = "0123456789",
                        ...
                        new
                        {
                            ...
                            NgayCapNhat = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5337),
                            NgaySinh = new DateTime(1995, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5336),
                            SDT = "0987654321",
            ...
            modelBuilder.Entity("ShoseSport.API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TaiKhoanId = new Guid("11111111-1111-1111-1111-111111111111"),
                            KhachHangId = new Guid("99999999-9999-9999-9999-999999999999"),
                            NgayTaoTaiKhoan = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(4847),
                            Password = "123456",
                            TrangThai = true,
                            UserName = "admin"
                        },
                        ...
                        {
                            TaiKhoanId = new Guid("55555555-5555-5555-5555-555555555555"),
                            NgayTaoTaiKhoan = new DateTime(2026, 3, 9, 8, 31, 11, 210, DateTimeKind.Utc).AddTicks(5028),
                            Password = "123456",
                            TrangThai = true,
                            UserName = "nhanvien"
                        });
